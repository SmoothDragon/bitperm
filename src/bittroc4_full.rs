...
impl BitTroc4Full {
    ...
    pub fn overlap(self, other: Self) -> bool {
        self.0.overlap(other.0) && self.1.overlap(other.1)
    }
}


impl BitOr for BitTroc4Full {
    type Output = Self;
...
// impl fmt::Debug for BitTroc4Full {
    // fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        // write!(f, "{}\n{}", self.c4, self.c3)
    // } 
// } 

impl fmt::Display for BitTroc4Full {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "{:}\n{:}", self.0, self.1)
    }
} 
...
mod test {
    ...
    const FULL: BitTroc4Full = BitTroc4Full(BitCube4(0xffff_ffff_ffff_ffff_u64), BitCube4(0xffff_ffff_ffff_ffff_u64));
    const ORDER: BitTroc4Full = BitTroc4Full(BitCube4(0xfedc_ba98_7654_3210_u64), BitCube4(0xfedc_ba98_7654_3210_u64));
    ...
    fn test_debug() {
        assert_eq!(format!("{:?}", ORDER),
            "BitTroc4Full(BitCube4(0xfedcba9876543210), BitCube4(0xfedcba9876543210))"
        );
    }
    ...
    fn test_shift_x() {
        assert_eq!(FULL.shift_x(1), 
                   BitTroc4Full(BitCube4(0xeeee_eeee_eeee_eeee_u64), BitCube4(0xeeee_eeee_eeee_eeee_u64))
                   );
    }
